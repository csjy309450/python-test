...
int main(int argc,char *argv[])
{
    ...
    source = gst_element_factory_make("filesrc","file-source"); //取文件
    decoder = gst_element_factory_make("mad","mad-decoder"); //mp3解码器
    sink = gst_element_factory_make("autoaudiosink","audio-output"); //播放输出
