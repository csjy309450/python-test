...
tf.app.flags.DEFINE_string('eval_dir', '/home/yangzheng/myPrograms/Libs_test/tensorflow/py_tensorflow_test/body/cifar10_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/yangzheng/myPrograms/Libs_test/tensorflow/py_tensorflow_test/body/cifar10_train',
...
list_file = ('validation_images.txt', 'validation_labels.txt')
...
def eval_once(saver, summary_writer, top_k_op, summary_op, batchReader, images, labels):
  """Run Eval once.
  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      num_iter = int(batchReader.getDataCount() / FLAGS.batch_size)
...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    while True:
      eval_once(saver, summary_writer, top_k_op, summary_op, batchReader, images, labels)
      if FLAGS.run_once:
        break
